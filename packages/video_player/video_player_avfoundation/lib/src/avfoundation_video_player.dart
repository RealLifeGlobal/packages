...
class _PlayerInstance {
  ...
  Future<List<PlatformVideoQuality>> getAvailableQualities() => _api.getAvailableQualities();

  Future<PlatformVideoQuality?> getCurrentQuality() => _api.getCurrentQuality();

  Future<void> setMaxBitrate(int maxBitrateBps) => _api.setMaxBitrate(maxBitrateBps);

  Future<void> setMaxResolution(int width, int height) => _api.setMaxResolution(width, height);
